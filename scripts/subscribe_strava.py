...
Callback URL: {BACKEND_URL}{STRAVA_WEBHOOK_CALLBACK_PATH}

Your backend must be reachable at BACKEND_URL when you run this (Strava sends a GET
to validate the callback). Use ngrok for local dev.
"""
import sys
...
from src.services.strava_webhook_subscription import (
    create_subscription,
    get_subscription,
    delete_subscription,
)
