...
from src.core.crypto_utils import decrypt_value, encrypt_value
from src.modules.identity.models import User
from src.modules.third_party.strava.client import StravaOAuthClient
...
class StravaService:
    ...
    def exchange_code(self, code: str, state: str | None) -> UserStrava | None:
        ...
        token_expires_at = (
            _strava_expires_at_to_datetime(expires_at) if expires_at else datetime.now(timezone.utc)
        )
